...
import ExamPatternPage, { generateMetadata } from './page';
...
describe('ExamPatternPage generateMetadata', () => {
  it("titles the page after the board's name", async () => {
    ...
    await expect(generateMetadata(params('board-1'))).resolves.toEqual({
      title: 'DSSSB Exam Pattern — TAPS',
      description: 'Exam pattern articles for DSSSB.',
    });
  });
