...
`TAPS-4.5` (quiz-generation chunking, `docs/adr/025-quiz-generation-paper-chunking.md`) is done.
`TAPS-4.6` (Chanakya-font Devanagari mojibake) is in review (PR #68). `TAPS-4.4` (seed real content
in production, still needing a founder/product decision on which board(s)) remains open. Sprints
1–6 summaries: `docs/sprints/`. Backlog: `docs/backlog/BACKLOG.md`.
